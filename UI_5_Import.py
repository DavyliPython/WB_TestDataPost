...
class Ui_winImportData(object):
    def setupUi(self, winImportData):
        ...
        self.btnBrowse_in.setGeometry(QtCore.QRect(520, 18, 131, 28))
        self.btnBrowse_in.setObjectName("btnBrowse_in")
        self.btnImport = QtWidgets.QPushButton(winImportData)
        self.btnImport.setGeometry(QtCore.QRect(530, 520, 131, 41))
        self.btnImport.setObjectName("btnImport")
        self.label_4 = QtWidgets.QLabel(winImportData)
        self.label_4.setGeometry(QtCore.QRect(25, 63, 81, 16))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(winImportData)
        self.label_5.setGeometry(QtCore.QRect(145, 63, 31, 16))
        self.label_5.setObjectName("label_5")
        self.groupBox = QtWidgets.QGroupBox(winImportData)
        self.groupBox.setGeometry(QtCore.QRect(10, 300, 661, 81))
        ...
        self.teDataFromTime.setReadOnly(True)
        self.teDataFromTime.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.teDataToTime.setReadOnly(True)
        self.teDataToTime.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.progressBar.setGeometry(QtCore.QRect(10, 530, 511, 23))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.qleFilePath_in = QtWidgets.QLineEdit(winImportData)
        self.qleFilePath_in.setGeometry(QtCore.QRect(110, 20, 401, 22))
        ...
        self.tblreviewdata.setGeometry(QtCore.QRect(10, 92, 661, 192))
        ...
        self.tblreviewdata.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectItems)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 390, 661, 121))
        ...
        self.teFromTime.setCurrentSection(QtWidgets.QDateTimeEdit.HourSection)
        ...
        self.btnReset.setGeometry(QtCore.QRect(520, 20, 131, 28))
        ...
        self.qleToRow.setReadOnly(True)
        ...
        self.qleFromRow.setReadOnly(True)
        ...
        self.qleFilePath_out.setReadOnly(False)
        ...
        self.btnSelectNone = QtWidgets.QPushButton(winImportData)
        self.btnSelectNone.setGeometry(QtCore.QRect(260, 56, 131, 28))
        self.btnSelectNone.setObjectName("btnSelectNone")
        self.btnSelectAll = QtWidgets.QPushButton(winImportData)
        self.btnSelectAll.setGeometry(QtCore.QRect(430, 56, 131, 28))
    ...
    def retranslateUi(self, winImportData):
        ...
        self.btnReset.setText(_translate("winImportData", "Reset"))
        ...
        self.btnSelectNone.setText(_translate("winImportData", "Select None"))
        self.btnSelectAll.setText(_translate("winImportData", "Select All Columns"))
